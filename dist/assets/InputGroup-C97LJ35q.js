...
`,[s("input, textarea",`
 ...
 `),w("&:-webkit-autofill ~",[s("placeholder","display: none;")])]),M("round",[U("textarea","border-radius: calc(var(--n-height) / 2);")]),s("placeholder",`
 pointer-events: none;
 position: absolute;
 left: 0;
 right: 0;
 ...
 `)]),M("textarea",[s("placeholder","overflow: visible;")]),U("autosize","width: 100%;"),M("autosize",[s("textarea-el, input-el",`
 position: absolute;
 top: 0;
 left: 0;
 height: 100%;
 ...
 display: flex;
 align-items: center; 
 `)])]),U("textarea",[s("placeholder","white-space: nowrap;")]),s("eye",`
 display: flex;
 align-items: center;
 ...
 `),["warning","error"].map(t=>M(`${t}-status`,[U("disabled",[m("base-loading",`
